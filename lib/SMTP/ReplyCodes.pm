...
our @EXPORT = qw(
SYSTEM_STATUS SYSTEM_HELP_REPLY HELP_MESSAGE READY
CLOSING_TRANSMISSION OK USER_NOT_LOCAL CANNOT_VRFY_USER

START_MAIL_INPUT

NOT_AVAILABLE MAILBOX_UNAVAILABLE ERROR_IN_PROCESSING
INSUFFICIENT_SYSTEM_STORAGE UNABLE_TO_ACCOMMODATE_PARAMETERS

SYNTAX_ERROR COMMAND_UNRECOGNIZED ERROR_IN_PARAMETERS
COMMAND_NOT_IMPLEMENTED BAD_SEQUENCE_OF_COMMANDS PARAMETER_NOT_IMPLEMENTED
MAILBOX_UNAVAILABLE USER_NOT_LOCAL EXCEEDED_STORAGE_ALLOCATION
MAILBOX_NAME_NOT_ALLOWED TRANSACTION_FAILED NO_SMTP_SERVICE_HERE
